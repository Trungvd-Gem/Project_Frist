        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 8, 7, 16, 32, 34, 824, DateTimeKind.Local).AddTicks(1667)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 8, 7, 16, 32, 34, 842, DateTimeKind.Local).AddTicks(2946), 100000m, 200000m, null });
